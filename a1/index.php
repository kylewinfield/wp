...
<body>
  ...
  <main>
    <article>
      <section class="main" , id="parallaxImg1">
      ...
      <section class="main" , id="parallaxImg2">
        <h2>CUTS</h2>
        <h3>Haircuts</h3>
        <p>
        ...
        <h3>Shave</h3>
        <p>
          Shaving can be a messy and disastrous procedure, we've all seen and heard the worst of it
